...
/**
 * Author: wangwei
 * Date: 2019-07-03 01:06
 * Version: 1.0
 * Desc: 获取微信apiclient_cert.p12证书
 */
public class CertHttpUtil {
    ...
    private static void initCert(String mchId, String certPath) throws Exception {
        ...
        // 读取本机存放的PKCS12证书文件
        // TODO: 2019-07-03 微信证书读取
//        ClassPathResource cp = new ClassPathResource("apiclient_cert.p12");
        ClassPathResource cp = new ClassPathResource("config/apiclient_cert.p12");
        InputStream instream = cp.getStream();
        try {
            // 指定PKCS12的密码(商户ID)
